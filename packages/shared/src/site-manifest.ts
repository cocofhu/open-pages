...
export function looksLikeOpenPagesPublishedContent(options: {
  ...
  return (
    configYaml.includes("generated by Open Pages") ||
    readme.includes(OPEN_PAGES_SOURCE_URL) ||
    (readme.includes("本仓库由") && readme.includes("open-pages"))
  );
}
...
export function assessRepoRootForPublish(options: {
  ...
  if (looksLikeOpenPagesPublishedContent({
